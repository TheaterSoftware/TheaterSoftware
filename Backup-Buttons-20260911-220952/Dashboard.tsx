    ...
    >
      ...
      >
        ...
        >
          ...
          {canManageEmailOutbox && <button type="button" onClick={onOpenReservationMail}
            style={{minHeight:160,border:"1px solid #ddd",borderRadius:12,background:"white",padding:24,textAlign:"left",cursor:"pointer",color:"#000"}}>
            <strong style={{display:"block",fontSize:20,marginBottom:8}}>Reservierungsbestätigung mit Zahlungslink</strong>
            <span style={{color:"#666"}}>Vorlage je Event, manueller Versand und letzte Erinnerung nach fünf Tagen.</span>
          </button>}
          {canManageEmailOutbox && (
            <button
              type="button"
            ...
            >
              ...
              <span style={{ color: "#666" }}>
                Vorbereitete und versendete E-Mails prüfen und manuell senden.
              </span>
            </button>
          )}
          {isAdmin && (
